...
#     try:
#         # 1. Use requests to save the image from the image_url form
#         # param to a temp local file.
...
#         # 2. Use the meme object to generate a meme using this temp file and
#         # the body and author form parameters.
...
def meme_post():
    ...
    try:
        ...
        error = 'Invalid URL'
        return render_template('meme_error.html', error=error)
